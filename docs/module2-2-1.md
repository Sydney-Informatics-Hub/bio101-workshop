...
??? question "Activity part 1: Valid replication or pseudoreplication?"
    ...
    ![](figs/wagner2025_fig1_replication_v03.jpg){width=90%}
...
![Statistical power depends on both effect size and within-group variance; minimum sample sizes from power analysis](figs/wagner2025_fig2_A.jpg){width=90%}
...
??? question "Activity part 3: How would you determine the right *n*?"
    ...
    ![Two sampling designs](figs/wagner2025_fig1_replication_v03.jpg){width=90%}
